...
// export const deleteTag = async (db: SQLJsDatabase | ExpoSQLiteDatabase, id: string) => {
...
// export const deleteTimer = async (db: SQLJsDatabase | ExpoSQLiteDatabase, id: string) => {
