...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label ref={ref} className={cn("native:text-base px-2 py-1.5 text-sm font-semibold text-foreground web:cursor-default", inset && "pl-8", className)} {...props} />
));
