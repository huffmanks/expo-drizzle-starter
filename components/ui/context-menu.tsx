  ...
  return (
    <ContextMenuPrimitive.Portal hostName={portalHost}>
      <ContextMenuPrimitive.Overlay
        style={
          overlayStyle ? StyleSheet.flatten([Platform.OS !== "web" ? StyleSheet.absoluteFill : undefined, overlayStyle] as ViewStyle) : Platform.OS !== "web" ? StyleSheet.absoluteFill : undefined
        }
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Label ref={ref} className={cn("native:text-base px-2 py-1.5 text-sm font-semibold text-foreground web:cursor-default", inset && "pl-8", className)} {...props} />
));
...
const ContextMenuShortcut = ({ className, ...props }: React.ComponentPropsWithoutRef<typeof Text>) => {
