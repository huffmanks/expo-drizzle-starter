  ...
  ({ className, children, variant, size, ...props }, ref) => {
    ...
    return (
      <TextClassContext.Provider
        value={cn(toggleTextVariants({ variant, size }), ToggleGroupPrimitive.utils.getIsSelected(value, props.value) ? "text-accent-foreground" : "web:group-hover:text-muted-foreground")}>
