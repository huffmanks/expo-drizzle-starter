...
const H1 = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component role="heading" aria-level="1" className={cn("text-4xl font-extrabold tracking-tight text-foreground web:select-text web:scroll-m-20 lg:text-5xl", className)} ref={ref} {...props} />
  );
});
...
const H2 = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      role="heading"
      aria-level="2"
      className={cn("border-b border-border pb-2 text-3xl font-semibold tracking-tight text-foreground first:mt-0 web:select-text web:scroll-m-20", className)}
      ref={ref}
      {...props}
    />
  );
...
const H3 = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText;
  return <Component role="heading" aria-level="3" className={cn("text-2xl font-semibold tracking-tight text-foreground web:select-text web:scroll-m-20", className)} ref={ref} {...props} />;
});
...
const H4 = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText;
  return <Component role="heading" aria-level="4" className={cn("text-xl font-semibold tracking-tight text-foreground web:select-text web:scroll-m-20", className)} ref={ref} {...props} />;
});
...
const BlockQuote = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      ...
      className={cn("native:mt-4 native:pl-3 mt-6 border-l-2 border-border pl-6 text-base italic text-foreground web:select-text", className)}
      ref={ref}
      {...props}
    />
  );
...
const Code = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      ...
      className={cn("relative rounded-md bg-muted px-[0.3rem] py-[0.2rem] text-sm font-semibold text-foreground web:select-text", className)}
      ref={ref}
      {...props}
    />
  );
...
const Large = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText;
  return <Component className={cn("text-xl font-semibold text-foreground web:select-text", className)} ref={ref} {...props} />;
});
...
const Small = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText;
  return <Component className={cn("text-sm font-medium leading-none text-foreground web:select-text", className)} ref={ref} {...props} />;
});
